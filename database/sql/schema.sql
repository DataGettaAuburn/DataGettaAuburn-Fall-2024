...
-- Foreign key constraints for "practice_pitching_data"
ALTER TABLE "practice_pitching_data"
...
-- Foreign key constraints for "practice_batting_data"
ALTER TABLE "practice_batting_data"
    ADD FOREIGN KEY ("Batter", "BatterTeam") REFERENCES "players" ("PlayerName", "TeamName") ON DELETE CASCADE,
    ADD FOREIGN KEY ("PitchUID") REFERENCES "practice_trackman_metadata" ("PitchUID") ON DELETE CASCADE;

-- Foreign key constraints for "practice_catching_data"
ALTER TABLE "practice_catching_data"
